...
import com.six.jdcom.sort.adpater.ShopcartAdapter;
import com.six.jdcom.sort.bean.GoodsInfo;
import com.six.jdcom.sort.bean.Select;
import com.six.jdcom.sort.bean.StoreInfo;
...
public class FragmentThree extends Fragment implements ISelectView, ShopcartAdapter.CheckInterface, ShopcartAdapter.ModifyCountInterface, ShopcartAdapter.GroupEdtorListener {
